  <!-- Navbar -->
  <nav class="main-header navbar navbar-dark navbar-expand-md bg-body-tertiary" style="box-shadow: 0 3px 6px 0 rgba(0, 0, 0, 0.1), 0 6px 20px 0 rgba(0, 0, 0, 0.10);">
    <div class="container">
      ...
      <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link" href="../logout.php">
            <i class="fas fa-sign-out-alt" onclick="return confirm('are you sure want to logout?');"> Logout</i>
          </a>
        </li>
      </ul>
    </div>
